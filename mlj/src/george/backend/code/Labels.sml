...
(* Labels:LABELS implements basic labels in the back end.  Labels are used for storing
   ...
   This is the optimised version of Labels where we do not
   store strings for labels *)
...
*)
   fun new_named_label s=new_label()
...
*)   )
   ...
   fun l2(l)=Numbers.i2(index(l))
   fun l4(l)=Numbers.i4(index(l))

   fun o2(l,i)=Numbers.i2(index(l)-i)
   fun o4(l,i)=Numbers.i4(index(l)-i)
end
